 ...
 */
@Component(name = "KorapXMLImporterComponent", factory = "PepperImporterComponentFactory")
public class KorapXMLImporter extends PepperImporterImpl implements PepperImporter{
	/** this is a logger, for recording messages during program process, like debug messages**/
	private static final Logger logger = LoggerFactory.getLogger(KorapXMLImporter.class);
	 ...
	 * module unique.
	 */
	public KorapXMLImporter() {
		super();
		setName("KorapXMLImporter");
	 ...
	 * sample mapper of type {@link KorapXMLMapper}, which only produces a fixed
	 * document-structure in method {@link KorapXMLMapper#mapSDocument()} and
	 * enhances the corpora for further meta-annotations in the method
	 * {@link KorapXMLMapper#mapSCorpus()}. <br/>
	...
	public PepperMapper createPepperMapper(Identifier Identifier) {
		KorapXMLMapper mapper = new KorapXMLMapper();
		/**
	 ...
	 * {@link KorapXMLMapper#mapSDocument()} and enhances the corpora for further
	 * meta-annotations in the method {@link KorapXMLMapper#mapSCorpus()}. <br/>
