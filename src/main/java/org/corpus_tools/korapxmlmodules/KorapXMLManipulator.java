 ...
 */
@Component(name = "KorapXMLManipulatorComponent", factory = "PepperManipulatorComponentFactory")
public class KorapXMLManipulator extends PepperManipulatorImpl {
	// =================================================== mandatory
	// ===================================================
	/**
	 ...
	 * module unique.
	 */
	public KorapXMLManipulator() {
		super();
		setName("KorapXMLManipulator");
	 ...
	 */
	public static class KorapXMLMapper extends PepperMapperImpl implements GraphTraverseHandler {
		/**
		...
		public DOCUMENT_STATUS mapSDocument() {
			...
			// depth-first order top down. The id 'KorapXMLTraversal' is used for
			...
			getDocument().getDocumentGraph().traverse(roots, GRAPH_TRAVERSE_TYPE.TOP_DOWN_DEPTH_FIRST, "KorapXMLTraversal", this);
