...
/**
 * This is a dummy implementation of a JUnit test for testing the {@link KorapXMLExporter} class. Feel free to adapt and
 * enhance this test class for real tests to check the work of your importer. If you are not confirm with JUnit, please
 * have a look at <a
 * href="http://www.vogella.com/tutorials/JUnit/article.html">
 * http://www.vogella.com/tutorials/JUnit/article.html</a>. <br/>
 * Please note, that the test class is derived from {@link PepperExporterTest}. The usage of this class should simplfy
 * your work and allows you to test only your single importer in the Pepper environment.
 *
...
public class KorapXMLExporterTest extends PepperExporterTest {
	...
	/**
	 * This method is called by the JUnit environment each time before a test case starts. So each time a method
	 * annotated with @Test is called. This enables, that each method could run in its own environment being not
