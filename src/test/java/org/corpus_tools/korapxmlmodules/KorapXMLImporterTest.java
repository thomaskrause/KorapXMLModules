...
import org.corpus_tools.korapxmlmodules.KorapXMLImporter;
 ...
 * {@link KorapXMLImporter} class. Feel free to adapt and enhance this test class
 ...
 */
public class KorapXMLImporterTest extends PepperImporterTest {
	/**
	...
	@Before
	public void setUp() {
		setFixture(new KorapXMLImporter());
	...
	public void test_DummyImplementation() {
		...
		getFixture().getCorpusDesc().setCorpusPath(getTempURI("KorapXMLImporter"));
