...
import org.corpus_tools.korapxmlmodules.KorapXMLManipulator;
 ...
 * {@link KorapXMLManipulator} class. Feel free to adapt and enhance this test
 ...
 */
public class KorapXMLManipulatorTest extends PepperManipulatorTest {
	/**
	...
	@Before
	public void setUp() {
		setFixture(new KorapXMLManipulator());
	}
